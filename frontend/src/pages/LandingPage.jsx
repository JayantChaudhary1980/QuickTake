  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 left-1/2 h-[520px] w-[720px] -translate-x-1/2 rounded-full bg-violet-600/30 dark:bg-violet-600/20 blur-[120px]" />
        <div className="absolute top-1/3 -right-32 h-[400px] w-[400px] rounded-full bg-sky-600/20 dark:bg-sky-600/20 dark:bg-sky-500/10 blur-[100px]" />
          ...
          <div className="mx-auto mt-12 grid max-w-4xl grid-cols-1 gap-3 sm:grid-cols-3">
            <Card className="border-border/60 bg-card/50">
              <CardContent className="flex items-center gap-3">
                <span className="rounded-md bg-violet-600/10 p-2 text-violet-600 dark:text-violet-400">
            ...
            <Card className="border-border/60 bg-card/50">
              <CardContent className="flex items-center gap-3">
                <span className="rounded-md bg-sky-600/20 dark:bg-sky-600/10 p-2 text-sky-600 dark:text-sky-400">
            ...
            <Card className="border-border/60 bg-card/50">
              <CardContent className="flex items-center gap-3">
                <span className="rounded-md bg-emerald-600/20 dark:bg-emerald-600/10 p-2 text-emerald-600 dark:text-emerald-400">
              ...
              <div className="grid gap-4 p-6 md:grid-cols-2">
                <div className="space-y-3 rounded-lg border border-border/60 bg-muted/30 p-4">
                    ...
                    <p className="text-sm leading-relaxed">
                        <span className="text-violet-600 dark:text-violet-400 font-medium">Roadmap:</span>{" "}
                        Align on Q2 priorities before allocating resources.
                    </p>

                    <p className="text-sm leading-relaxed">
                        <span className="text-sky-600 dark:text-sky-400 font-medium">Demo:</span>{" "}
                        Review onboarding flow demonstrated during screen sharing.
                    </p>

                    <p className="text-sm leading-relaxed">
                        <span className="text-emerald-600 dark:text-emerald-400 font-medium">Next Steps:</span>{" "}
      ...
      <footer
        id="contact"
        className="border-t border-border/60 bg-background/50 py-12"
      >
      <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-12 md:grid-cols-[2.5fr_1fr_1.5fr_1fr]">
          <div>
          ...
          <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} QuickTake. Built by <span className="font-bold text-violet-600 dark:text-violet-400">Jayant Chaudhary</span>.
          </p>
          ...
          <div className="flex items-center gap-5">
              ...
              <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group mt-3 flex items-center gap-3 rounded-lg border border-violet-500/30 bg-violet-600/15 dark:bg-violet-500/10 px-4 py-3 transition-all duration-300 hover:border-violet-400 hover:bg-violet-600/30 dark:bg-violet-600/20 dark:bg-violet-500/15 hover:shadow-lg hover:shadow-violet-500/10"
                  >
                  <div className="flex h-9 w-9 items-center justify-center rounded-md bg-violet-500/20 text-violet-600 dark:text-violet-400">
                      <svg
              ...
              <a
                  ...
                  rel="noreferrer"
                  aria-label="LinkedIn"
                  className="text-muted-foreground transition-colors hover:text-sky-600 dark:text-sky-400"
              >
                  <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
...
function FeatureCard({ title, description, icon: Icon }) {
  return (
    ...
    >
      <CardHeader>
        <div className="mb-2 flex size-10 items-center justify-center rounded-lg bg-violet-600/30 dark:bg-violet-600/20 dark:bg-violet-500/15 text-violet-600 dark:text-violet-400">
